...
| [`llm`](./llm) | Master's coursework (Machine Learning Technologies): an essay on symbolic vs. connectionist AI, a Fashion MNIST deep-learning architecture study, and an LLM social-bias audit of GPT-2/DistilGPT-2/Mistral-7B. | Python, TensorFlow, Hugging Face Transformers, PyTorch |
...
- **LLM coursework:** notebooks include their original executed outputs; the second lab requires a GPU runtime to reproduce (loads Mistral-7B in 4-bit quantization).
